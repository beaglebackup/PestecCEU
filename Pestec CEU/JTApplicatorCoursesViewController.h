...
@interface JTApplicatorCoursesViewController : JTTopicBaseViewController <UITableViewDelegate, UITableViewDataSource>
...
//@property (nonatomic, strong) JTWorkerTypeIndex workerType;
